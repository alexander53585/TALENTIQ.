...
export const buildPredictPrompt = f => `Eres experto en Análisis de Puestos en Latinoamérica.
...
export const buildConditionsPrompt = f => `Eres experto en Recursos Humanos.
...
export const buildFnAssistPrompt = (raw, puesto, area) => `Eres experto en Analisis de Puestos.
...
export const buildFinalPrompt = (f, mode, fnData) => {
...
/* ═══════════════ STORAGE ═══════════════ */
export const saveDesc = async (result, form, mode) => {
    try {
...
export const deleteDesc = async k => {
...
export const mkInitLevantar = () => ({
    ...
    funciones: [{ raw: "", desc: "", freq: 3, impact: 2, complexity: 3, aiStatus: null, aiSuggestion: null, confirmed: false },
