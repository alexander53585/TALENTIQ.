...
import { C, FF, FREQ_OPTS, IMPACT_OPTS, COMPLEXITY_OPTS, emptyFn, calcScore } from "./tokens";
import { Tag } from "./Atoms";
import { buildFnAssistPrompt, parseAiJson } from "./prompts";

/* ═══════════════ FUNCTION TABLE ═════════════════ */
export function FunctionTable({ funciones, onChange, puesto, area }) {
...
export function EssentialPrioritization({ funciones, essentialFunctions, onChange }) {
    ...
    const isEssential = idx => essentialFunctions.includes(idx);
