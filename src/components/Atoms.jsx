...
/* ═══════════════ TAG / BADGE ═════════════════ */
export function Tag({ children, color, variant = "default" }) {
...
/* ═══════════════ STEPPER ═════════════════ */
export function Stepper({ current, steps, subStep }) {
    return (
...
/* ═══════════════ FIELD / INPUT ═════════════════ */
export const Field = memo(function Field({ field, value, onChange, isAI = false }) {
...
/* ═══════════════ SPINNER ═════════════════ */
export function Spinner({ label, sub }) {
    return (
        <div style={{
...
/* ═══════════════ NAV ═════════════════ */
export function Nav({ screen, mode, step, onReset, company, onSignOut, onToggleAdmin, userEmail }) {
