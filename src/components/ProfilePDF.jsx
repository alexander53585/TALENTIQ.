...
/* ═══════════════ PDF DOCUMENT ═══════════════ */
export const ProfileDocument = ({ result, form, mode, company, sections }) => {
    const r = result || {};
    const showAll = !sections || sections.length === 0;
    const show = key => showAll || sections.includes(key);

    const hasEssential = safeArray(r.responsabilidadesClave).some(f => f.esEsencial);
                ...
                {show("funciones") && (
                    <View wrap={false}>
                        ...
                        <View style={s.table}>
                            ...
                            {safeArray(r.responsabilidadesClave).map((fn, i) => (
                ...
                {show("indicadores") && safeArray(r.indicadoresExito).length > 0 && (
                    <View wrap={false}>
                        ...
                        <View style={s.table}>
                            ...
                            {safeArray(r.indicadoresExito).map((kpi, i) => (
                ...
                {show("competencias") && (
                    <View wrap={false}>
                        ...
                        <View style={s.table}>
                            ...
                            {safeArray(g(r, "perfilIdeal.competenciasClave", [])).map((comp, i) => {
                    ...
                    <View wrap={false}>
                        ...
                        {safeArray(r.indicadoresExito).length > 0 && (
                            <View style={{ marginTop: 8 }}>
                                ...
                                <View style={s.twoCol}>
                                    {safeArray(r.indicadoresExito).slice(0, 3).map((kpi, i) => (
                    ...
                    <View wrap={false}>
                        ...
                        <View style={s.twoCol}>
                            <View style={[s.col, s.table]}>
                                ...
                                {safeArray(r.valuacionCargo.factores).map((f, i) => (
                                    <View style={[s.row, i % 2 === 1 && s.rowAlt]} key={i}>
                    ...
                    <View wrap={false}>
                        ...
                        <View style={s.twoCol}>
                            <View style={[s.col, s.table]}>
                                ...
                                {safeArray(r.relacionesInternas).map((rel, i) => (
                                    <View style={[s.row, i % 2 === 1 && s.rowAlt]} key={i}>
                            ...
                            <View style={[s.col, s.table]}>
                                ...
                                {safeArray(r.relacionesExternas).map((rel, i) => (
                                    <View style={[s.row, i % 2 === 1 && s.rowAlt]} key={i}>
