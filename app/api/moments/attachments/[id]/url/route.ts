 ...
 *
 * Seguridad:
 * - Autenticación requerida (getRequestContext lanza si no hay sesión)
...
export async function GET(
  ...
  try {
    ...
    // ── 2. Buscar adjunto filtrando por organization_id ───────────────
    ...
    // ── 3. Generar URL firmada (service_role, expira pronto) ──────────
    ...
    // Errores de auth (NotAuthenticatedError, ForbiddenError) delegados a toErrorResponse
